...
export declare class DataFeed {
    ...
    private subscribeToProduct(cmd);
    private unsubscribeFromProduct(cmd);
    private initExchange(exchange, products, feed);
    private sendTicker(cmd);
    private sendOrderbookState(cmd);
}
